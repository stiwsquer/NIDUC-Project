...
M=64;            %Iloœæ punktów w konstelacji sygna³u
...
amountOfBits = 10000; %Iloœæ bitów przechodz¹cych przez kana³ transmisyjny
...
%Kana³ transmisyjny
awgnChannel = comm.AWGNChannel('BitsPerSymbol',bitsPerSymbol); %Stworzenie obiektu reprezentuj¹cego kana³ transmisyjny. 
...
display('Szybkoœæ transmisji (iloœæ bitów przesy³anych w jednym okresie fali noœnej): ');
...
%     errVec = [0 0 0];
%     %Ustawiamy stosunek mocy sygna³u do mocy szumu w kanale (SNR)
